...
from ai.backend.manager.models import domains
...
def upgrade():
    ...
    op.create_foreign_key(op.f('fk_users_domain_name_domains'), 'users', 'domains', ['domain_name'], ['name'])
    ...
    if results is None:
        query = (sa.insert(domains)
                   .values(name='default', description='Default domain', is_active=True,
