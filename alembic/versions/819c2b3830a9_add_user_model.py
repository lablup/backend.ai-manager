...
def upgrade():
    ...
    op.create_table(
        'users',
        sa.Column('uuid', ai.backend.manager.models.base.GUID(), server_default=sa.text('uuid_generate_v4()'), nullable=False),
        sa.Column('username', sa.String(length=64), nullable=True),
        sa.Column('email', sa.String(length=64), nullable=False),
        sa.Column('password', ai.backend.manager.models.user.PasswordColumn(), nullable=True),
    ...
    op.add_column('keypairs', sa.Column('user', ai.backend.manager.models.base.GUID(), nullable=True))
    ...
    query = sa.select([keypairs.c.user_id, keypairs.c.access_key, keypairs.c.is_admin]).select_from(keypairs)
