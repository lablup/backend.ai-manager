...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['domain_name'], ['domains.name'], name=op.f('fk_groups_domain_name_domains'), onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['group_id'], ['groups.id'], name=op.f('fk_association_groups_users_group_id_groups'), onupdate='CASCADE', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.uuid'], name=op.f('fk_association_groups_users_user_id_users'), onupdate='CASCADE', ondelete='CASCADE'),
