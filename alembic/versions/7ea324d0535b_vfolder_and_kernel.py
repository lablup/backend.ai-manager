...
def upgrade():
    ...
    op.create_table('vfolder_attachment',
    sa.Column('vfolder', sorna.manager.models.base.GUID(), nullable=False),
    sa.Column('kernel', sorna.manager.models.base.GUID(), nullable=False),
