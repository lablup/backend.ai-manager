...
def upgrade():
    ...
    op.create_table('vfolder_invitations',
    ...
    sa.ForeignKeyConstraint(['vfolder'], ['vfolders.id'], name=op.f('fk_vfolder_invitations_vfolder_vfolders'), onupdate='CASCADE', ondelete='CASCADE'),
