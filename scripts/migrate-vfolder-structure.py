...
def main():
    ...
    try:
        ...
        for folder in subfolders:
            ...
            Path(output_path / header_dir).mkdir(parents=True, exist_ok=True)
            Path(output_path / header_dir / second_lvl_dir).mkdir(parents=True, exist_ok=True)
            Path(output_path / header_dir / second_lvl_dir / rest_dir).mkdir(parents=True, exist_ok=True)
