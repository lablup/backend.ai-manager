...
def upgrade():
    ...
    op.create_table('pipeline_module_tag',
    sa.Column('name', sa.String(length=64), nullable=False),
    sa.PrimaryKeyConstraint('name', name=op.f('pk_pipeline_module_tag'))
    )
    op.create_table('pipeline_module',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('icon', sa.String(length=256), nullable=False),
    sa.Column('type', ai.backend.manager.models.base.EnumType('COMPUTE_SESSION', 'MANAGER_TASK'), nullable=False),
    ...
    op.create_table('pipeline_module_input',
    ...
    op.create_table('pipeline_module_output',
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False),
    ...
    op.create_table('pipeline_module_tag_association',
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('pipeline_module_version',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('pipeline_template_version',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('status', ai.backend.manager.models.base.EnumType('PENDING', 'RUNNING', 'FINISHED', 'ERROR', 'CANCELLED'), nullable=False),
    ...
    op.create_table('pipeline_template_task',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('icon', sa.String(length=256), nullable=False),
    sa.Column('type', ai.backend.manager.models.base.EnumType('COMPUTE_SESSION', 'MANAGER_TASK'), nullable=False),
    ...
    op.create_table('pipeline_template_task_input',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False),
    ...
    op.create_table('pipeline_template_task_output',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False),
    ...
    sa.Column('type', ai.backend.manager.models.base.EnumType('COMPUTE_SESSION', 'MANAGER_TASK'), nullable=False),
    sa.Column('task_spec', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('status', ai.backend.manager.models.base.EnumType('PENDING', 'RUNNING', 'SUCCESS', 'FAILED', 'ERROR', 'CANCELLED'), nullable=False),
    sa.Column('last_updated', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_table('pipeline_template_task_link',
    sa.Column('template_vid', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('pipeline_task_output',
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('module_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False),
    ...
    op.create_table('pipeline_task_link',
    sa.Column('pipeline_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('task_output_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('task_input_id', postgresql.UUID(as_uuid=True), nullable=False),
