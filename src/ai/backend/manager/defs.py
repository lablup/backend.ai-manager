...
class AdvisoryLock(enum.Enum):
    LOCKID_TEST = 'LOCKID_TEST'
    LOCKID_SCHEDULE = 'LOCKID_SCHEDULE'
    LOCKID_PREPARE = 'LOCKID_PREPARE'
    LOCKID_SCHEDULE_TIMER = 'LOCKID_SCHEDULE_TIMER'
    LOCKID_PREPARE_TIMER = 'LOCKID_PREPARE_TIMER'
    LOCKID_LOG_CLEANUP_TIMER = 'LOCKID_LOG_CLEANUP_TIMER'
    LOCKID_IDLE_CHECK_TIMER = 'LOCKID_IDLE_CHECK_TIMER'
